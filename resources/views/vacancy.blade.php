...
<div class="w-full bg-white dark:bg-gray-800">
 <div class="relative w-5/6 p-5 mx-auto text-gray-800 bg-white rounded shadow-xl mb-30 dark:bg-gray-700 sm:p-5 md:text-left">
        ...
        <div class="items-center mx-5 md:flex">
            ...
            <div class="w-full px-5 md:w-1/2">
                <div class="mb-10">
                    <p class="text-sm dark:text-white">Mejores Vacantes<br></p>
                    <h1 class="mb-5 text-2xl font-bold uppercase dark:text-white">{{ $vacancy->Title }}</h1>
                    <p class="text-sm dark:text-white">{{ $vacancy->DescriptionVacancy }}</p>
                    <br>
                    {{-- tnecnologias --}}
                ...
                <div class="flex flex-row mt-5 md:flex-col lg:flex-row">
                    <div>
                        ...
                        <div class="flex mt-4 md:mt-0 lg:mt-4">
                            ...
                            <p class="flex-0.5 dark:text-white"> {{ $vacancy->Location }}</p>
                        </div>
                        <!-- info empresa -->
                       <div class="flex mt-6">
                            <p class="flex-0.5 mb-5  md:mb-0 lg:mb-5 font-bold uppercase text-md dark:text-white">Empresa:</p>
                            <p class="flex-0.5 dark:text-white">{{ $vacancy->recrutier->NameCompany }}</p>
                       </div>
                    </div>
                    <div class="ml-4">
                        <div class="flex mx-auto mt-2">
                            <a class="flex-0.5 mb-5 uppercase text-sm" href= {{ $vacancy->recrutier->WebsiteCompany }} target="_blank">
                        ...
                        <div class="flex">
                            <div class="flex mt-4 md:mt-0 lg:mt-4">
                                ...
                                <p class="flex-0.5 dark:text-white">{{ $vacancy->created_at->diffForHumans() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex-1 mt-5">
                ...
                <div class="flex">
                    ...
                    <div class="flex-0.5 ml-4 inline-block mr-5 align-bottom">
                        <span class="text-2xl font-medium leading-none align-baseline dark:text-white">{{ $vacancy->Salary }}</span>
                        <span class="font-light leading-none align-baseline text-md dark:text-white">{{ $vacancy->currency }}</span>
                    </div>
                </div>
